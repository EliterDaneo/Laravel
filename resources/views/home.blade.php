...
<head>
    ...
    <link rel="icon" href="{{ asset('bootstrap') }}/assets/img/favicons/favicon-32x32.png" sizes="32x32"
        type="image/png">
    <link rel="icon" href="{{ asset('bootstrap') }}/assets/img/favicons/favicon-16x16.png" sizes="16x16"
        type="image/png">
    <link rel="manifest" href="{{ asset('bootstrap') }}/assets/img/favicons/manifest.json">
    <link rel="mask-icon" href="{{ asset('bootstrap') }}/assets/img/favicons/safari-pinned-tab.svg" color="#7952b3">
    <link rel="icon" href="{{ asset('bootstrap') }}/assets/img/favicons/favicon.ico">
    ...
    <link href="{{ asset('bootstrap') }}/dist/css/main.css" rel="stylesheet">
</head>
